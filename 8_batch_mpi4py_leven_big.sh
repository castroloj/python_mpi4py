...
#SBATCH --job-name=8_mpi_leven                  # Job name
...
#SBATCH --output=8_mpi_leven.txt                # name of the file to save the output
...
srun -n 256 python -u 8_mpi_leven_big.py 10

srun -n 256 python -u 8_mpi_leven_big.py 20
