...
#SBATCH --job-name=9_mpi_leven                  # Job name
...
#SBATCH --output=9_mpi_leven.txt                # name of the file to save the output
...
srun -n 640 python -u 8_mpi_leven_big.py 10

srun -n 640 python -u 8_mpi_leven_big.py 20
